...
$(function(){
    ...
    if($('#fos_user_profile_form_country').hasClass('error')){
        ...
        $( $('#edit_profile_form .country-dropdown select.select2-dropdown').select2("container") ).addClass('error');
    }

    if($('.date-birthday').hasClass('error')){
        $('.date-birthday .ui-dropdown').addClass('error');
        $('.date-birthday .select2-choice').addClass('error');
        $( $('.date-birthday select.select2-dropdown').select2("container") ).addClass('error');
    }
